      ...
      <div className="md:w-[80%] mx-auto flex flex-col lg:flex-row items-center gap-10 md:gap-14">
        ...
        <div data-aos="fade-left">
          ...
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed mt-6">
            ...
            <a className="font-semibold text-blue-200" href="https://www.du.ac.in/">Delhi University</a>{" "}
            and a Korean Language Certificate from{" "}
            <a className="font-semibold text-blue-200" href="https://www.hanyang.ac.kr/web/eng">Hanyang University</a>, South Korea. {" "}
